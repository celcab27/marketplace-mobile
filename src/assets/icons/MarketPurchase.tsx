...
function MarketPurchaseIcon({fillColor = '#000000'}) {
  return (
    <Svg fill={fillColor} width="20px" height="20px" viewBox="0 0 1000 1000">
...
export default MarketPurchaseIcon;
// Note: The above code is a simplified version of the MarketPurchase icon.
